...
const ideasReducer = (state = {ideas: ["start"], events: ['start'], friends: ["start"], user:{id:349, first_name: "hardwired first name", last_name: 'hardwired last name', email: "hardwired email"}, nonFriends: ['start']}, action) => {
  switch (action.type) {
